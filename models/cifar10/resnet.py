...
def ResNet34(device):
    return ResNet(BasicBlock, [3, 4, 6, 3], device=device)


def ResNet50(device):
    return ResNet(Bottleneck, [3, 4, 6, 3], device=device)


def ResNet101(device):
    return ResNet(Bottleneck, [3, 4, 23, 3], device=device)


def ResNet152(device):
    return ResNet(Bottleneck, [3, 8, 36, 3], device=device)
